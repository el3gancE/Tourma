...
/**
 * Controller for Double Elimination Tournament Bracket Page & AJAX Score Updates.
 */
@WebServlet(name = "DoubleEliminationServlet", urlPatterns = {"/double-elimination"})
public class DoubleEliminationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Map<String, Object> deData = doubleEliminationDAO.getDoubleEliminationData(intTourneyId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (matchIdStr != null && score1Str != null && score2Str != null) {
                ...
                boolean success = doubleEliminationDAO.updateMatchScore(matchId, score1, score2, winnerFlag);
