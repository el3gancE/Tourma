<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@page import="dao.TournamentDAO" %>
        <%@page import="model.Tournament" %>
            <% String activeStep=request.getParameter("activeStep"); if (activeStep==null ||
                activeStep.trim().isEmpty()) { activeStep="format" ; } String tournamentId=request.getParameter("id");
                String tournamentName="Giải Đấu Single" ; if (tournamentId !=null && !tournamentId.trim().isEmpty()) {
                TournamentDAO tDao=new TournamentDAO(); Tournament t=tDao.getTournamentById(tournamentId); if (t !=null
                && t.getName() !=null) { tournamentName=t.getName(); } } %>
                    ...
                    <ul class="sidebar-menu-list">
                        ...
                        <li class="sidebar-menu-item">
                            <a href="${pageContext.request.contextPath}/common/configure-tournament-format.jsp?id=<%= tournamentId != null ? tournamentId : "" %>"
                                class="sidebar-menu-link <%= " format".equals(activeStep) || "step1" .equals(activeStep)
                                ? "active" : "" %>">
                        ...
                        <li class="sidebar-menu-item">
                            <a href="${pageContext.request.contextPath}/common/configure-tournament-teams.jsp?id=<%= tournamentId != null ? tournamentId : "" %>"
                                class="sidebar-menu-link <%= " teams".equals(activeStep) || "step2" .equals(activeStep)
                                ? "active" : "" %>">
                        ...
                        <li class="sidebar-menu-item">
                            <a href="${pageContext.request.contextPath}/common/tournament-bracket.jsp?id=<%= tournamentId != null ? tournamentId : "" %>"
                                class="sidebar-menu-link <%= " bracket".equals(activeStep) || "step3"
