    ...
    <body>
        ...
        <main class="container has-sidebar">
            ...
            <div class="form-container-box" style="margin-top: 0;">
                ...
                <form id="configureFormatForm"
                    action="${pageContext.request.contextPath}/common/configure-tournament-teams.jsp" method="GET">
                    ...
                    <div class="form-group">
                        ...
                        <div class="format-pill-grid">
                            <button type="button" class="format-pill-btn active" id="pillSingleElim"
                                onclick="selectFormat('SINGLE_ELIMINATION')">
                                Single Elimination
                            </button>
                            <button type="button" class="format-pill-btn" id="pillDoubleElim"
                                onclick="selectFormat('DOUBLE_ELIMINATION')">
                                Double Elimination
                            </button>
                            <button type="button" class="format-pill-btn" id="pillRoundRobin"
                                onclick="selectFormat('ROUND_ROBIN')">
                                Round Robin
                            </button>
                        </div>
                    </div>

                    <!-- 2. CHI TIẾT CẤU HÌNH ĐIỂM -->
                    <div id="wdlPointsPanel"
                        ...
                        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 0.6rem;">
                            <div>
                                <label class="form-label" style="font-size: 0.75rem; color: var(--text-muted);">Điểm
                                    Thắng</label>
                            ...
                            <div>
                                <label class="form-label" style="font-size: 0.75rem; color: var(--text-muted);">Số Lần
                                    Gặp Nhau</label>
                    ...
                    <div style="display: flex; justify-content: flex-end; gap: 0.75rem; margin-top: 1.75rem;">
                        <a href="${pageContext.request.contextPath}/create-tournament.jsp?id=${param.id}"
